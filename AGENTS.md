...
Key modules:
- `agent.py`: builds Strands agents from specs, tools, MCP servers, skills, and hooks.
...
- `hooks.py`: declarative `[[hooks]]` specs compiled into Strands prompt/tool/stop callbacks.
